package com.example.myapplication.ui.dashboard.wheelsruflibrary.view;
...
public class WheelSurfView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if ( attrs != null ) {
            //获得这个控件对应的属性。
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, com.example.myapplication.R.styleable.wheelSurfView);
            try {
    ...
    public static final class Builder {
        ...
        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmType(int mType) {
            this.mType = mType;
            return this;
        }

        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmTypeNum(int mTypeNum) {
            this.mTypeNum = mTypeNum;
            return this;
        }

        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmGoImgRes(int mGoImgRes) {
            this.mGoImgRes = mGoImgRes;
            return this;
        }

        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmMinTimes(int mMinTimes) {
            this.mMinTimes = mMinTimes;
            return this;
        }

        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmVarTime(int mVarTime) {
            this.mVarTime = mVarTime;
            return this;
        }

        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmDeses(String[] mDeses) {
            this.mDeses = mDeses;
            return this;
        }

        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmIcons(List<Bitmap> mIcons) {
            this.mIcons = mIcons;
            return this;
        }

        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmColors(Integer[] mColors) {
            this.mColors = mColors;
            return this;
        }

        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmMainImgRes(Integer mMainImgRes) {
            this.mMainImgRes = mMainImgRes;
            return this;
        }

        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmHuanImgRes(Integer mHuanImgRes) {
            this.mHuanImgRes = mHuanImgRes;
            return this;
        }

        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmTextSize(float mTextSize) {
            this.mTextSize = mTextSize;
            return this;
        }

        public final com.example.myapplication.ui.dashboard.wheelsruflibrary.view.WheelSurfView.Builder setmTextColor(int mTextColor) {
